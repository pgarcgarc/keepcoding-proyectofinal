...
Q1 <- quantile(df_airbnb$RoomPrice, 0.25, na.rm = TRUE)
Q3 <- quantile(df_airbnb$RoomPrice, 0.75, na.rm = TRUE)
...
outliers <- df_airbnb$RoomPrice[df_airbnb$RoomPrice < lower_bound | df_airbnb$RoomPrice > upper_bound]

# Imprimir outliers
print(outliers)

# Crear un boxplot para la columna 'price'
boxplot(df_airbnb$RoomPrice, main = "Boxplot of Price", ylab = "Price")

# Identificar los valores atípicos del boxplot
outliers <- boxplot.stats(df_airbnb$RoomPrice)$out
